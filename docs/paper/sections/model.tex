...
2.19, Java 17, single-threaded, $<$1~s wall-clock).  The
mechanized proof is the empirical floor of the analytical proof
above; \Cref{tab:tlc-stats} summarizes the per-spec model-checking
