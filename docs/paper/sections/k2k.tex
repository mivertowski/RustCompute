...
goes through global memory.  Latencies are H100~NVL measurements
from \Cref{sec:evaluation}.  The runtime selects the tier based on
the placement of source and destination actors.}
\label{fig:k2k-tiers}
\end{figure}
