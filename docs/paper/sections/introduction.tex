...
optional idempotency cache; we prove
(\Cref{thm:delivery-at-least-once}) that the underlying queue
semantics yield at-least-once delivery and per-(source,\,destination)
ordering.
