...
We claim five contributions, presented in the order they unfold in
the paper:
...
5.54\,M~messages/second sustained throughput, 0.628\,\(\mu\)s
cluster-level synchronization, and 12,500\(\times\) speedup
relative to the kernel-launch model on a workload representative of
