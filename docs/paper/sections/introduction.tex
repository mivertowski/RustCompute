...
5.54\,M~messages/second sustained throughput at coefficient of
variation 0.05\% over 60~seconds, 0.628\,\(\mu\)s cluster-level
synchronization (2.98\(\times\) faster than grid-wide
synchronization), and 116.9\(\times\) async memory-allocation
speedup over classical \texttt{cuMemAlloc}.
