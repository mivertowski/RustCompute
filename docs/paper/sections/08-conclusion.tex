...
\begin{enumerate}
    ...
    C\#/.NET (DotCompute, Orleans.GpuBridge), with a combined 6,500+ tests.
    ...
    analytics, demonstrating broad applicability.

    \item \textbf{Comprehensive Evaluation}: We demonstrated 250-11,000$\times$ lower
    command latency and O(1) query time for living analytics compared
...
\begin{itemize}
    \item 6,500+ tests across all implementations
