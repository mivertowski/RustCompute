...
\begin{enumerate}
    ...
    \item \textbf{Application-Layer Digital Twin}: We presented RustAssureTwin, a
    production desktop application (Tauri~2 + Svelte~5 + Rust) that consumes
    GPU-native actor state to provide audit intelligence with bi-temporal analytics,
    three-tier AI agents, and ISA/PCAOB-compliant workflows---validating the full
    stack from GPU kernel to professional end-user.
...
RustAssureTwin & \url{https://github.com/mivertowski/RustAssureTwin} \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{itemize}
    \item 7,500+ tests across all implementations (RustGraph: 1,350+, Orleans.GpuBridge: 1,231,
    RingKernel: 900+, RustAssureTwin: 504, DotCompute: 215)
    ...
    \item RustAssureTwin: production desktop application with bi-temporal analytics,
    AI agent integration, and ISA/PCAOB-compliant audit workflows
    \item Example applications for each domain (FDTD, virtual actors, graph analytics, audit)
